...
package x_rootpackage_x.general.logic.base;
...
import AbstractUc.java.AbstractBeanMapperSupport;
 ...
 */
public class AbstractUc extends AbstractBeanMapperSupport {
   ...
   */
  protected <T extends TransferObject, E extends PersistenceEntity<?>> PaginatedListTo<T> mapPaginatedEntityList(PaginatedListTo<E> paginatedList,
      Class<T> klass) {
   ...
   */
  protected static <ID, E extends GenericEntity<ID>> List<E> getEntities2Delete(Collection<E> currentEntities, Collection<E> entitiesToSave) {
